    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'productly',
          imageUrl: 'productly',
          status: ' landing page leverages the power of Bootstrap JS as its front-end framework, ensuring a responsive and visually appealing design.',
            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm text-status">
                    {{ item.status }}
                  </div>
